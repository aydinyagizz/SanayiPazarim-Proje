                             ...
                             <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">                                          
                                    <div class="form-group">
                                        ...
                                        <input type="mail" id="first-name" required="" placeholder="Mail Adresinizi Giriniz" name="kullanici_mail" class="form-control">
                                    </div>
                                </div>
                            ...
                            <div class="row">
                              ...
                              <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">                                           
                                    <div class="pLace-order">
                                        <button class="update-btn disabled" type="submit" name="kullanicikaydet" >Gönder</button>
                                    </div>
                                </div>
                            </div> 
